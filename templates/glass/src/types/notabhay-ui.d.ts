declare module "@notabhay-ui/ui" {
  ...
  export function DialogContent(props: ComponentProps<"div"> & { className?: string; showCloseButton?: boolean }): ReactNode;
  ...
  export function DialogFooter(props: ComponentProps<"div"> & { className?: string; showCloseButton?: boolean }): ReactNode;
