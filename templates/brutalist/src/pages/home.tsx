    ...
    <div>
      ...
      <section className="border-b-4 border-border">
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr]">
          ...
          >
            ...
            <h1 className="font-heading text-5xl md:text-7xl lg:text-8xl font-bold uppercase leading-[0.9] tracking-tight mb-8">
              SHIP
              <br />
              FASTER
          ...
          {/* Right: data block */}
          <motion.div
            className="border-t-4 lg:border-t-0 lg:border-l-4 border-border bg-muted p-8 md:p-12 flex flex-col justify-center"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <section className="border-b-4 border-border bg-foreground text-background overflow-hidden py-3">
        <div className="flex whitespace-nowrap">
          <p className="font-heading text-xs uppercase tracking-[0.3em] animate-[marquee_20s_linear_infinite]">
            REAL-TIME ANALYTICS &nbsp;&bull;&nbsp; DEPLOY TRACKING &nbsp;&bull;&nbsp; REVIEW VELOCITY &nbsp;&bull;&nbsp; INCIDENT RESPONSE &nbsp;&bull;&nbsp; TEAM METRICS &nbsp;&bull;&nbsp; REAL-TIME ANALYTICS &nbsp;&bull;&nbsp; DEPLOY TRACKING &nbsp;&bull;&nbsp; REVIEW VELOCITY &nbsp;&bull;&nbsp; INCIDENT RESPONSE &nbsp;&bull;&nbsp; TEAM METRICS &nbsp;&bull;&nbsp;
          </p>
        </div>
        <style>{`
          @keyframes marquee {
      ...
      {/* ── Features: Boxed asymmetric grid ─────────────────── */}
      <section className="border-b-4 border-border">
        <div className="p-8 md:p-12 border-b-4 border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          {features.map((feature, i) => {
            ...
            return (
              <motion.article
                key={feature.tag}
                className={`border-b-4 border-border p-8 md:p-12 ${
                  i % 2 === 0 ? "md:border-r-4" : ""
                }`}
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
      ...
      <section className="grid grid-cols-2 md:grid-cols-4">
        {[
          ...
          <div
            key={item.label}
            className={`p-6 md:p-8 border-b-4 border-border ${
              i < 3 ? "border-r-4" : ""
            }`}
          >
